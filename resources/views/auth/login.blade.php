                    ...
                    <div class="w-full">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <label class="block text-sm">
                                ...
                                <input type="email" name="email" id="email" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="{{old('email')}}" placeholder="Email" autofocus/>
                                @error('email')
                            ...
                            <p>
                                <label for="remember_me" class="flex items-center mt-4 text-sm">
                            ...
                            <div class="flex items-center justify-between mt-4">
                                <p>
                                    ...
                                    <a href="{{ route('password.request') }}" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="./forgot-password.html">
