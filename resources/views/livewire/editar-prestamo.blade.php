<div>
    ...
    <div class="max-w-4xl mx-auto p-4 md:p-0 py-6 md:py-10 dark:text-gray-300 rounded-lg bg-white dark:bg-gray-800">
                ...
                <div class="flex items-center mb-4">
                    <div class="flex-1">
                        <label class="block text-sm">
                            ...
                            <input wire:model="customer_id" type="text" readonly disable class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Descripción"/>
                        </label>
                    </div>
                </div>
        ...
        <footer class="flex items-center justify-between dark:bg-gray-800 mt-4">
            <a href="{{route('prestamos.index')}}" class="w-full px-5 py-3 mr-1 text-sm font-medium leading-5 text-white text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg dark:text-gray-400 sm:px-4 sm:py-2 sm:w-auto active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray">
                Cancelar
            </a>
